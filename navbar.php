...
<div id='phases'>
	...
	<div id="phasesBody">
		...
		<div id="Step01" class="current">
			Step 1
			<div>
				Fill in the text boxes, then select your Clan<br />
				<?php echo $nav->showCode(); ?>
			</div>
		</div>
